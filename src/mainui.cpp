    ...
    chu(new QLabel("楚河")), han(new QLabel("汉界"))
{
    ...
    connect(button,&QPushButton::clicked,[=](){emit sendmess(text->text());});
    connect(button,&QPushButton::clicked,text,&QLineEdit::clear);
    connect(this,&MainUI::sendmess,Network::getInstance(),&Network::sendMessage);
